...
exports.edit = exports.create = exports.getByEmail = exports.getById = exports.getAll = void 0;
...
const getAll = async (params) => {
    ...
    const countPromise = client_1.default.user.count({ where });
    const rowsPromise = client_1.default.user.findMany({
        skip,
        take,
        orderBy: [{ id: 'desc' }],
        where
